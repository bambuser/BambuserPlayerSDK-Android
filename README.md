...
|-----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `OnPlay`                          | The show starts playing                                                                                                                | `showId: String` - Id of show <br> `title: String` - The title of the show <br> `isLive: Boolean` - Is the show live                                                                                                                                                                                   |
...
| `OnAddToCalendar`                 | The add to calendar button on the pre-live curtain is clicked, if the show has a scheduled start time                                  | `date: Long` - The shows scheduled start time <br> `durationInMilliseconds: Int` - Duration of the show in milliseconds <br>  `url: String?` - The show url <br> `showId: String` - The show Id <br> `title: String` - The title of the show <br> `description: String?` - The description of the show |
| `OnShare`                         | The share button is clicked                                                                                                            | `url` - Url of show                                                                                                                                                                                                                                                                                    |
...
| `OnProductDescriptionLinkClicked` | The user clicks on the product description link                                                                                        | `link: String` - The link that was clicked                                                                                                                                                                                                                                                             |
...
| `PDPEvent.OnBuyClicked`           | The user clicks on the buy button inside of the PDP                                                                                    | `product: Product` - A model representing the product to be opened <br> `colorVariantId: String?` - Color variant id of the product <br> `sizeVariantId: String?` - Size variant id of the product                                                                                                     |
...
| `PlayerCartCheckoutTapped`        | The user clicks the checkout button in the cart                                                                                        | -                                                                                                                                                                                                                                                                                                      |
| `PlayerCartItemUpdated`           | The player cart is updated                                                                                                             | `item: CartProduct` - A model representing the product in the cart <br> `isRemoved: Boolean` - Is the product removed from the cart                                                                                                                                                                    |
...
| `playerCartSyncItem`    | Sync cart changes with the player                   | `context` - Application context <br> `isEUServer` - Is the server restricted to EU <br> `cartProduct: CartProduct` - The product being synced <br> `isRemove: Boolean` - Is the product removed from the cart                                                                                                                                                                             |
| `playerCartInit`        | Init player cart with cart products                 | `context` - Application context <br> `isEUServer` - Is the server restricted to EU <br> `cartProducts: List<CartProduct>` - The initial cart products                                                                                                                                                                                                                                     |
| `provideProductDetails` | Provide function for returning full product details | `onProductDetailsRequested` - Function in which you can provide us with more information for full PDP                                                                                                                                                                                                                                                                                     |
